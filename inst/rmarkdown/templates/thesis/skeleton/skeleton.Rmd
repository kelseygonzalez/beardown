...
member_A: 'Member A. Name'
member_B: 'Member B. Name'
member_C: 'Member C. Name'
knit: bookdown::render_book
site: bookdown::bookdown_site
# This will automatically install the {remotes} package and {beardown}
# Change this to FALSE if you'd like to install them manually on your own.
params:
  'Install needed packages for {beardown}': True
  
# Remove the hashtag to specify which version of output you would like.
# Can only choose one at a time.
output:
  beardown::thesis_pdf: default 
#  beardown::thesis_gitbook: default         
#  beardown::thesis_word: default
#  beardown::thesis_epub: default

# If you are creating a PDF you'll need to write your preliminary content 
# (e.g., abstract, acknowledgements) below or use code similar to line 25-26 
# for the .RMD files. If you are NOT producing a PDF, delete or silence
# lines 25-39 in this YAML header.
abstract: '`r if(knitr:::is_latex_output()) paste(readLines(here::here("index", "prelims", "00-abstract.Rmd")), collapse = "\n  ")`'
...
# This chunk ensures that the beardown package is
# installed and loaded. This beardown package includes
...
```{r eval=!knitr::is_latex_output(), child=here::here("index", "prelims", "00--prelim.Rmd")}

```

```{r eval=!knitr::is_latex_output(), child=here::here("index", "prelims", "00-abstract.Rmd")}
